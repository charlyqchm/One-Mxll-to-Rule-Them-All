...
!###################################################################################################
    ...
    subroutine init_operator(this, dr, freq, grid_Ndims ,dimensions, n_pml, boundaries,&
                             mpi_dims, mpi_coords)
        ...
        if (this%cpml_pos(2)) then
            ...
            do i = n_pml, 1, -1
                ...
                kappa = 1.0d0 + (kappa_max_pml - 1.0d0) * ((n_pml-i+1)/n_pml)**m_pml
                s_i   = kappa + sig / (Z_I * this%w0 * e0)
                this%s_inv_x(ii) = (1.0d0 / s_i - 1.0d0)
                ii = ii + 1
            end do
        end if
        ...
        if (this%cpml_pos(4)) then
            ...
            do i = n_pml, 1, -1
                ...
                kappa = 1.0d0 + (kappa_max_pml - 1.0d0) * ((n_pml-i+1)/n_pml)**m_pml
                s_i   = kappa + sig / (Z_I * this%w0 * e0)
                this%s_inv_y(ii) = (1.0d0 / s_i - 1.0d0)
                ii = ii + 1
            end do
        end if
        ...
        if (this%cpml_pos(6)) then
            ...
            do i = n_pml, 1, -1
                ...
                kappa = 1.0d0 + (kappa_max_pml - 1.0d0) * ((n_pml-i+1)/n_pml)**m_pml
                s_i   = kappa + sig / (Z_I * this%w0 * e0)
                this%s_inv_z(ii) = (1.0d0 / s_i - 1.0d0)
                ii = ii + 1
            end do
        end if
